# The iotta Enterprise License (the "Enterprise License")

Copyright (c) 2025-present Elias Bergmann

With regard to the iotta Software:

This software and associated documentation files (the "Software") may only be used in production, if
you (and any entity that you represent) hold a valid iotta Enterprise license corresponding to your
usage. Subject to the foregoing sentence, you are free to modify this Software and publish patches
to the Software. You agree that iotta and/or its licensors (as applicable) retain all right, title and
interest in and to all such modifications and/or patches, and all such modifications and/or patches
may only be used, copied, modified, displayed, distributed, or otherwise exploited with a valid iotta
...
agree that iotta and/or its licensors (as applicable) retain all right, title and interest in and to
...
For all third party components incorporated into the iotta Software, those components are licensed
